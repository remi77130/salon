document.addEventListener("DOMContentLoaded", function() {
    ...
    let logoBase64 = "";  // Variable pour stocker le logo en base64
    let bgImageBase64 = "";  // Variable pour stocker l'image d'arrière-plan en base64
       ...
       document.getElementById('logo').addEventListener('change', function(event) {
        ...
        document.getElementById('background-image').addEventListener('change', function(event) {
            ...
            if (file) {
                const reader = new FileReader();
                reader.onload = function(e) {
                    bgImageBase64 = e.target.result; // Stocker l'image d'arrière-plan en base64
                };
                reader.readAsDataURL(file);  // Lire le fichier comme base64
            }
        });
