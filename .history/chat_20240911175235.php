...
<script>
	...
	function createChat(user, display = true) {
			...
			$('.modal').hide();
			    ...
			    // Vérifie si l'utilisateur clique sur son propre profil
			...
			if (!$chat.length) {
				...
				<div id="${id}" class="modal">
					<div class="chat-popup">
						...
						<div class="chat-footer"${isSelf ? 'style="display:none;"' : ''}>>
...
<script>
    const currentUserId = <?php echo $_SESSION['user']; ?>; // ID de l'utilisateur connecté
</script>
