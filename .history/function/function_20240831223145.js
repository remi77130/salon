...
// Ce fichier gère l'interaction côté client, y compris la connexion à Socket.io
...
window.addEventListener('load', () => {
    ...
    /* Récupérer l'ID de l'utilisateur connecté ici */
            ...
            container.innerHTML = `
                <div class="profile-content">
                    ...
                    <div id="message_user">
                        ...
                        echo '<p><strong>' . htmlspecialchars($user['age']) 
