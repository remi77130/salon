...
Attention, tu me dit qu'il y aura les utilisateur sur le fichier 'index.html' mais plus haut on avais déja créer la partie 
users dans un tableau qui récuépér l'avatar, le pseudo, lage et le genre. 
on avais placer tous ça dans un fichier appelé 'index.php

 Nous avons créer une page HTML qui contient un tableau pour 
 afficher les utilisateurs récupérés par l'API. Ce tableau sera mis à jour 
 automatiquement toutes les minutes grâce à AJAX. 
 -->
