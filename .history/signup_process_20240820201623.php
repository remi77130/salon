...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $ville_users = $_POST['ville_users']; // La ville sélectionnée
    $gender = $_POST['gender'];
    ...
    $stmt = $conn->prepare("INSERT INTO users (department, ville_users) VALUES (?, ?)");
    $stmt->bind_param("ss", $department, $ville);
    
    }
    
    $stmt->bind_param("ssiss", $pseudo, $avatarDestination, $age, $department, $ville_users, $gender);
